...
datos = [38, 27, 43, 3, 9, 82, 10, 55, 1, 99, 21] 
...
print("Merge Sort:", resultado_merge) 
print("Heap Sort:", resultado_heap) 
print("Tiempo Merge Sort:", fin_merge - inicio_merge) 
print("Tiempo Heap Sort:", fin_heap - inicio_heap)